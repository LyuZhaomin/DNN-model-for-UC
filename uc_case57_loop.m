...
savecase('case57_custom', mpc);  
mpc_test = loadcase('case57_custom');

baseMVA = mpc.baseMVA;
mui = randi([2,4], N_gen, 1);
mdi = randi([2,4], N_gen, 1);
...
% Step 3: Save Dataset
save('UC_dataset_case57.mat', 'inputs', 'outputs');
...
save('UC_train_test_case57.mat', 'X_train', 'Y_train', 'X_test', 'Y_test');
