...
savecase('case118_custom', mpc);  
mpc_test = loadcase('case118_custom');
...
P_mean_day = mean(P_hourly, 2); % 24×1 vector            
...
% The range is [(1-x)base_demand, (1+x)base_demand], x is 10%
...
% Step 3: Save Dataset
save('UC_dataset_case118.mat', 'inputs', 'outputs');
...
save('UC_train_test_case118.mat', 'X_train', 'Y_train', 'X_test', 'Y_test');
